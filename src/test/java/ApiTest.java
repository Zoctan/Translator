...
public class ApiTest {
    ...
    public void test() throws Exception {
        final String origin = "Forms has several layouts and features for organizing content on screen.\n Each layout control is described below, as well as details on how to handle screen orientation changes:xx";
